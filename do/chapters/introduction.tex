...
L'idea è quella di mantenere ottimali i livelli di inventario riguardanti il \glo{ciclo di vita} degli alimenti e delle bevande, valutandoli tramite test per verificarne la correttezza del modulo ed il funzionamento dello stesso.
